...
The **point-classifier** app was designed to play around with k-means clustering algorithm.
Let's see how!

## Step one
The first step is to generate some random points. The user can define the total number, the standard deviation along the X and Y axis and the number of clusters. 
...
## Try yourself!
### Play aroung with the parameters and see how clusters are identified.
